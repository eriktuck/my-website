---
date: 2025-12-01 10:00:00-05:00
draft: false
image: 
image-credit: 
summary: How my Masters degree unfolded hour by hour.
tags: ["Data Viz"]
title: A Data-Driven Retrospective of My Master’s Degree
---
...
While coursework was a focus, I was also able to take advantage of the time to build a few portfolio projects. I wrote about many on [Medium](https://medium.com/@eriktuck). One that sticks out is a [personal finance app](https://github.com/eriktuck/budgetbaby) I built with Plotly Dash, Firestore and Google Cloud Run.

> Click on the inner rings to zoom in. Click "MSDS" to see exactly which classes consumed the most bandwidth.

{{< iframe src="/interactive/sunburst.html" height="725" >}}
...
{{< iframe src="/interactive/barchart-timeseries.html" height="700" >}}

## Consistency is key 
This nod to the GitHub commit graph highlights the importance of making at least a little progress every day.

{{< iframe src="/interactive/calendar-heatmap.html" height="300" >}}
...
{{< video src="https://storage.googleapis.com/ei-dev-assets/assets/barchart-race.mp4" autoplay="true" loop="true" >}}
...
{{< iframe src="/interactive/radar-chart.html" height="900" >}}

## Learning out loud
I published my notes, research and musings as I went through my Master's here on my [Knowledge Hub](https://io.eriktuck.com). It's still very much a work in progress (and always will be). 
...
{{< video src="https://storage.googleapis.com/ei-dev-assets/assets/obsidian_trimmed.mp4" autoplay="true" loop="true" >}}
